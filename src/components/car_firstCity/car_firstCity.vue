<template>
  <div class="car_modelWrapper">
    <div class="car_model">
      <h2 class="model_title">初次入城</h2>
      <div class="img_feature">
        <div class="feature_text">图像特征</div>
      ...
      <div class="carPlate" >
        ...
        <div class="carPlate_radio">
          <div style="line-height: 32px;padding-right: 7px">排除车辆</div>
          <Input class="carPlate_inp" v-model="exclude" placeholder="请输入车牌"/>
        </div>
        <Row>
          <div class="startTime" >
            <span>起始时间</span>
        ...
        <div class="carPlate_radio" >
          <span  style="line-height: 32px;padding-right: 7px">回溯时长</span>
          <Input class="carPlate_inp"  v-model="backTime" placeholder="最多可写365"/>
          <span style="line-height: 32px;padding-left: 7px">天</span>
        </div >
      </div >
      <div class="modelTool">
        <car_tool></car_tool>
